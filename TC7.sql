...
BEGIN
  SA_USER_ADMIN.SET_USER_LABELS('TB_CSYT_policy', 'GDS', 'GDS:DTCS:TT'); 
  SA_USER_ADMIN.SET_USER_LABELS('TB_CSYT_policy', 'GDCSYT', 'GDCSYT:DTNT:NT'); 
  SA_USER_ADMIN.SET_USER_LABELS('TB_CSYT_policy', 'GDCSYT2', 'GDCSYT:DTCS:CTT'); 
  SA_USER_ADMIN.SET_USER_LABELS('TB_CSYT_policy', 'GDCSYT3', 'GDCSYT:DTCS:CTT');
  SA_USER_ADMIN.SET_USER_LABELS('TB_CSYT_policy', 'YBS', 'YBS:DTNT:TT');
END;
