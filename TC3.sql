...
INSTEAD OF UPDATE ON V_CSYT_HSBA
FOR EACH ROW
DECLARE
BEGIN
    INSERT INTO HSBA 
...
INSTEAD OF UPDATE ON QLYCSYT.V_CSYT_HSBA
FOR EACH ROW
DECLARE
BEGIN
    DELETE FROM HSBA 
...
/
--TAO VIEW CAU B
CREATE OR REPLACE VIEW V_HSBA_HSBA_DV
...
INSTEAD OF UPDATE ON V_HSBA_HSBA_DV
FOR EACH ROW
DECLARE
BEGIN
    INSERT INTO HSBA_DV 
...
INSTEAD OF UPDATE ON QLYCSYT.V_HSBA_HSBA_DV
FOR EACH ROW
DECLARE
BEGIN
    DELETE FROM HSBA_DV 
