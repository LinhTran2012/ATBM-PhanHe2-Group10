...
EXEC sp_THEMNHANVIEN('NV2',N'Do Tuong Vy', N'Nu', '2000-12-12','371953101', N'Kien Giang', '0777009958', 'CS1', N'Y sy/bac sy', NULL);
...
VALUES ('HSBA1', 'BN1', TO_DATE('2020-01-01', 'yyyy-mm-dd'), 'chuan doan 1', 'NV1', 'K1', 'CS1', 'ket luan 1');
